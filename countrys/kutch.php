...
margin-top: 3px;
  ...
  <body>
    ...
    <div class="kufsec">
      <center>
        <img class="kufimg" src="kutch.jpg" alt="" />
      </center>
      <hr>
      <img class="turist-logo" src="location.png" alt="">
      <h3 class="turist-lab"> Rann of Kutch</h3>
      <div class="kupara">
            <p class="fm">
    ...
    <div class="msec">
        ...
        <h3 class="turist-lab">img Gallary</h3>
      </div>

<!-- <div class="labgal">img galary</div> -->
    <div class="kugalary">
    <img class="kugalimg" src="Rann1.jpg" alt="">
    <img class="kugalimg" src="rann_02.jpg" alt="">
    <!-- <img class="kugalimg" src="/places/india/rann_03.jpg" alt=""> -->
    <img class="kugalimg" src="rann_04.jpg" alt="">
    <img class="kugalimg" src="runn_05.jpg" alt="">
    <img class="kugalimg" src="runn_06.jpg" alt="">
    <img class="kugalimg" src="rann_07.jpg" alt="">
    <img class="kugalimg" src="rann_08.jpg" alt="">
    <img class="kugalimg" src="Rann_09.jpg" alt="">
