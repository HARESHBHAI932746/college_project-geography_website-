...
if(isset($_POST['locname'])){
  ...
  if(isset($_POST['video'])){
    ...
    $tmp_video_name = $_FILES['video'] ['tmp_name'];
    move_uploaded_file($tmp_video_name,$video);
   }
  ...
  if(isset($_FILES['video'])){
   ...
   move_uploaded_file($file_tmp,"videoup2/".$file_name);
   ...
   $conn = mysqli_connect($sn,$un,$ps,$dbname);
    ...
    if(!$conn){
     die("something want wrong".mysqli_connect_error());
      ...
      $sql = "INSERT INTO `video` (`locname`,`comment`,`video`) VALUES ('$locname','$file_name$comment','$file_name')";
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="container">
        ...
        <form id="postForm" action="videosec.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="file" id="image" name="video" required>
            </div>
            <div class="form-group">
...
?>
    ...
    <div class="comment-section">
      <div class="comment">
        ...
        <video controls src="videoup2/<?=$video ?>" alt="" class="img">
      </div>
    </div>
    <?php } }?>
  </center>
